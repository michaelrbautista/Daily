//
//  AdvancedBaseTraining.swift
//  Daily
//
//  Created by Michael Bautista on 4/22/25.
//

class AdvancedBaseTraining {
    
    public static let shared = AdvancedBaseTraining()
        ...
        ProgramWeek(
            ...
            runs: [
                ...
                ProgramRun(type: .SpeedWorkout, workoutSegments: [
                    RunSegment(
                        title: "Warmup",
                        description: "10-15 minutes mile at an easy pace."
                    ),
                    RunSegment(
                        title: "Tempo",
        ...
        ProgramWeek(
            ...
            runs: [
                ...
                ProgramRun(type: .SpeedWorkout, workoutSegments: [
                    ...
                    RunSegment(
                        title: "Intervals",
                        description: "10 x 400m seconds at critical velocity pace. 60 seconds rest between each rep."
                    ),
                    RunSegment(
                        title: "Cooldown",
                        description: "10-15 minutes at an easy pace."
        ...
        ProgramWeek(
            ...
            runs: [
                ...
                ProgramRun(type: .SpeedWorkout, workoutSegments: [
                    ...
                    RunSegment(
                        title: "Intervals",
                        description: "12 x 400m seconds at critical velocity pace. 60 seconds rest between each rep."
                    ),
                    RunSegment(
                        title: "Cooldown",
                        description: "10-15 minutes at an easy pace."
        ...
        ProgramWeek(
            ...
            runs: [
                ...
                ProgramRun(type: .SpeedWorkout, workoutSegments: [
                    ...
                    RunSegment(
                        title: "Intervals",
                        description: "4 x 1000m seconds at critical velocity pace. 60 seconds rest between each rep."
                    ),
                    RunSegment(
                        title: "Cooldown",
                        description: "10-15 minutes at an easy pace."
        ...
        ProgramWeek(
            ...
            runs: [
                ...
                ProgramRun(type: .SpeedWorkout, workoutSegments: [
                    ...
                    RunSegment(
                        title: "Intervals",
                        description: "6 x 1000m seconds at critical velocity pace. 60 seconds rest between each rep."
                    ),
                    RunSegment(
                        title: "Cooldown",
                        description: "10-15 minutes at an easy pace."
